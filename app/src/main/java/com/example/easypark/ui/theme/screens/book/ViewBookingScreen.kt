...
@Composable
fun ViewBookingScreen(navController:NavHostController) {
    Column(modifier = Modifier
        ...
        var accounts = accountRepository.ViewBookings(emptyAccountState, emptyAccountsListState)
...
@Composable
fun BookingItem1(name:String, space:String, email:String, id:String,
    ...
    Column(modifier = Modifier
        ...
        Text(text = "Parking Category: $space",
            fontSize = 15.sp,
        ...
        Row {
            ...
            Button(onClick = { accountRepository.updateBooking(id)},
            ...
            Button(onClick = { accountRepository.deleteBooking(id)},
                shape = RoundedCornerShape(topEnd = 10.dp, bottomEnd = 10.dp),
