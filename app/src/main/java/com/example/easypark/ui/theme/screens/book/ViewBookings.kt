...
@Composable
fun ViewBookings(navController:NavHostController) {
...
@Composable
fun BookingItem(name:String, space:String, email:String, id:String,
...
fun ViewBookingsPreview(){

    ViewBookings(navController = rememberNavController())
