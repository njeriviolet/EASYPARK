package com.example.easypark.ui.theme.screens.payment
...
fun PaymentScreen(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    title = { Text(text = "easy park", fontFamily = FontFamily.SansSerif, color = Color.White)},
                ...
                Column(
                    ...
                    Row {
                        ...
                        Column(modifier = Modifier.padding(start=20.dp)) {
                            Text(text = "Visit EASYPARK,", fontSize = 20.sp)
                            Text(text = "BETTER PARKING!")
                            Row {
